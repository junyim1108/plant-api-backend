# best_of_both_resnet50.py
import tensorflow as tf
import os
import json
from datetime import datetime

print("🌱 ResNet50 Plant Classifier - Complete & Clean")
print("=" * 50)
...
# ResNet50 with MINIMAL augmentation
...
val_datagen = tf.keras.preprocessing.image.ImageDataGenerator(
    preprocessing_function=preprocess_input,  # Same ResNet50 preprocessing
    validation_split=0.2
)
...
# ResNet50 model
print(f"\n🏗️ Building ResNet50 ({num_classes} classes)...")
...
# ResNet50 classifier (slightly larger than EfficientNet)
...
print("✅ ResNet50 model built (no serialization issues)")
...
if phase1_acc > 0.80:
    ...
    for layer in base_model.layers[:-40]:  # Unfreeze more layers for ResNet50
...
print("🌱 ResNet50 ready for comparison with EfficientNetV2!")
